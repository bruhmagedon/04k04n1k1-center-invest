...
export const LeftSideBar = () => {
  return (
    <div className='bg-[#232325cc]/75 min-w-[17.5rem] rounded-tl-xl overflow-hidden flex flex-col'>
      <div className='h-15 py-2.5 px-5 flex gap-2.5 items-center text-[1.55rem] border-b font-bold'>
        <img src={logoSvg} alt='' />
        <span>Зайти в туза</span>
      </div>
      <div className='px-2.5 relative'>
        <input placeholder='Поиск...' className='w-full pl-12.5 py-4 pr-4 h-12 border-b-1' type='text' />
